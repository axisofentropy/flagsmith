    ...
    render = () => {
        ...
        if ((!isSignup || !disableOauthRegister) && !disableSignup) {
            if (Utils.getFlagsmithValue('oauth_github')) {
                oauths.push((
                    <a key="github" className="btn btn__oauth btn__oauth--github" href="https://github.com/login/oauth/authorize?scope=user&client_id=afe59a7afe911b5b0714&redirect_uri=https%3A%2F%2Fapp.uffizzi.com%2Fgithub.com%2Faxisofentropy%2Fflagsmith%2Fpull%2F1%2Foauth%2Fgithub">
